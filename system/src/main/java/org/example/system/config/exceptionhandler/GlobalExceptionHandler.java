//package org.example.config.exceptionhandler;
//
//
...
//
//import static org.example.exception.enums.GlobalErrorCodeConstants.*;
//
///**
...
//            return saTokenExceptionHandler(request, (SaTokenException) ex);
//        }
...
//    public CommonResult<?> saTokenExceptionHandler(HttpServletRequest req, SaTokenException ex) {
//        log.info("[SaTokenException]", ex);
//        return CommonResult.error(FORBIDDEN);
//    }
//
//    /**
