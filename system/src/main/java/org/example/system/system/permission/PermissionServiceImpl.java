...
import org.example.system.enums.DataScopeEnum;
import org.example.system.enums.MenuTypeEnum;
import org.example.system.enums.RedisKeyConstants;
import org.example.system.system.dept.DeptService;
import org.example.system.system.user.AdminUserService;
import org.example.system.vo.auth.vo.AuthPermissionInfoRespVO;
...
import static org.example.util.collection.CollectionUtils.filterList;
...
public class PermissionServiceImpl implements PermissionService {
     ...
     *
     * @param userId 用户编号
     * @return 用户拥有的角色 enable user role list by user id from cache
     */
...
// 移除按钮
        ...
        menuList.forEach(menu -> treeNodeMap.put(menu.getId(), mapperFacade.map(menu,AuthPermissionInfoRespVO.MenuVO.class)));
        // 处理父子关系
