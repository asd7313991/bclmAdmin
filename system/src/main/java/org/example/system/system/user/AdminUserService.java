...
public interface AdminUserService {
     ...
     *
     * @param deptIds 部门数组
     * @return 用户数组 user list by dept ids
     */
     ...
     *
     * @param postIds 岗位数组
     * @return 用户数组 user list by post ids
     */
     ...
     *
     * @param nickname 昵称
     * @return 用户列表 user list by nickname
     */
     ...
     * @return 导入结果 user import resp vo
     */
     ...
     *
     * @param status 状态
     * @return 用户们 user list by status
     */
