...
public interface TenantService {
     ...
     * @return 租户数量 tenant count by package id
     */
     ...
     *
     * @param packageId 租户套餐编号
     * @return 租户数组 tenant list by package id
     */
    ...
    /**
     * Select by id tenant do.
     *
     * @param tenantId the tenant id
     * @return the tenant do
     */
    TenantDO selectById(Long tenantId);
}
