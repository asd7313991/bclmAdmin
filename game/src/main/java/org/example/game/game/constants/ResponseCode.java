...
public class ResponseCode {
    ...
    public static final int USER_MONEY_LE_ZERO = 2208;   //支付金额必须大于0
    public static final int USER_MILI_LE_ZERO = 2209;   //支付米粒必须大于0

    public static final int USER_MONEY_EXCEPTION = 2210;   //支付金额和产品金额不一致

    public static final int USER_MILI_EQ_ZERO = 2211;   //现金支付不能使用米粒

    public static final int USER_MONEY_EQ_ZERO = 2212;   //米粒支付不能使用现金
    public static final int USER_PAY_TYPE_FAIL = 2213;   //用户支付方式不存在
    public static final int USER_PAY_ORDER_TYPE_FAIL = 2214;   //产品类型不存在

    public static final int USER_PAY_NO_SUPPORT = 2215;   //当前不支持米粒支付方式
    ...
    public static final int LOCK_IS_BUSY = 5000;  //  | 中间件异常(LOCK) |
    ...
    public static final int VIEWPOINT_LIKE_EXIST = 4720;    //当前用户已点赞该观点

    public static final int VIEWPOINT_IS_DELETED = 4721;    //当前观点已经删除

    public static final int VIEWPOINT_IS_HIDE = 4722;    //当前观点已下架

    public static final int VIEWPOINT_NO_PAY = 4723;    //您没有购买观点
     ...
     * bet
     */
    public static final int BET_ISSUE_ERROR = 6000; //期号错
