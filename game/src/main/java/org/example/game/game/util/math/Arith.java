package org.example.game.game.util.math;
...
public class Arith {
	...
	// @Deprecated
	public static int DEFAULT_DOT = 8;
	...
	public static double multiply(double x1, double x2, double x3, int dot) {
		return BigDecimal.valueOf(x1).multiply(BigDecimal.valueOf(x2)).multiply(BigDecimal.valueOf(x3))
				.setScale(dot, RoundingMode.HALF_UP).doubleValue();
	}
	...
	public static double multiply(double x1, double x2, double x3, double x4, int dot) {
		return BigDecimal.valueOf(x1).multiply(BigDecimal.valueOf(x2)).multiply(BigDecimal.valueOf(x3))
				.multiply(BigDecimal.valueOf(x4)).setScale(dot, RoundingMode.HALF_UP).doubleValue();
	}
	...
	public static double multiply(double x1, double x2, double x3, double x4, double x5, int dot) {
		return BigDecimal.valueOf(x1).multiply(BigDecimal.valueOf(x2)).multiply(BigDecimal.valueOf(x3))
				.multiply(BigDecimal.valueOf(x4)).multiply(BigDecimal.valueOf(x5)).setScale(dot, RoundingMode.HALF_UP)
				.doubleValue();
	}
	...
	public static double divide(double x1, double x2) {
		return divide(x1, x2, DEFAULT_DOT);
	}
	...
	public static void main(String[] args) {
		System.out.println(Arith.setScaleDown(0.7406999999999999, 2));
	}
}
