...
/**
 * 
 * @TableName dream_deposit_type
 */
@TableName(value ="dream_deposit_type")
@Data
public class DreamDepositTypeDO implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        DreamDepositTypeDO other = (DreamDepositTypeDO) that;
