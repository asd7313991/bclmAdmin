//package org.example.operatelog.core.aop;
//
...
//import org.example.operatelog.core.service.OperateLogFrameworkService;
//import org.example.operatelog.core.service.OperateLogObj;
//import org.example.pojo.CommonResult;
//import org.example.util.monitor.TracerUtils;
...
//import static org.example.exception.enums.GlobalErrorCodeConstants.SUCCESS;
//
//
///**
...
//                           OperateLog operateLog) throws Throwable {
//        // 目前，只有后台用户，才记录操作日志！所以非管理员，直接调用，不进行记录
...
//                      OperateLog operateLog,
//                      LocalDateTime startTime, Object result, Throwable exception) {
//        OperateLogObj operateLogObj = new OperateLogObj();
//        // 补全通用字段
...
//    }
//
//    private static void fillUserFields(OperateLogObj operateLogObj) {
//        operateLogObj.setUserId(WebFrameworkUtils.getLoginUserId());
//        operateLogObj.setUserType(WebFrameworkUtils.getLoginUserType());
//    }
//
//    private static void fillModuleFields(OperateLogObj operateLogObj,
...
//    }
//
//    private static void fillRequestFields(OperateLogObj operateLogObj) {
//        // 获得 Request 对象
...
//    }
//
//    private static void fillMethodFields(OperateLogObj operateLogObj,
//                                         ProceedingJoinPoint joinPoint,
//                                         OperateLog operateLog,
//                                         LocalDateTime startTime, Object result, Throwable exception) {
