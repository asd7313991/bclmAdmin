...
public interface DictTypeConstants {
    ...
    String QA_DEFAULT_TYPE = "qa_default_type";
    String QA_DEPOSIT_TYPE = "qa_deposit_type";
    String QA_WITHDRAW_TYPE = "qa_withdraw_type";
    String QA_PASSWORD_TYPE = "qa_password_type";
    String CUSTOMER_CONTACT = "customer_contact";
